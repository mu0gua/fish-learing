...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        optimizer= tf.compat.v1.train.AdamOptimizer(1e-3)  # 优化算法
        ...
        # 正确率与损失率
        loss_summary = tf.compat.v1.summary.scalar("loss", lstm_cnn.loss)
        acc_summary = tf.compat.v1.summary.scalar("accuracy", lstm_cnn.accuracy)
